...
// var elastic = "transform " + transitionTime + "ms cubic-bezier(0.68, -0.55, 0.265, 1.55)";
// var smooth = "transform " + transitionTime + "ms ease";
...
//     var _a = react_1.useReducer(carouselReducer, initialCarouselState), state = _a[0], dispatch = _a[1];
