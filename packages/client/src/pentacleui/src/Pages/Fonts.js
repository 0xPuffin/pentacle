    ...
    return (
      <Layout>
        ...
        <article>
          ...
          <p>
            The fonts are self-hosted and live in the `assets/fonts` dir.
            Licencing is via the Open Font Licence – via{" "}
            <a
              href={
                "https://fonts.google.com/specimen/Fira+Code?selection.family=Fira+Code&sidebar.open=true#license"
              }
            >
              Google fonts
            </a>
