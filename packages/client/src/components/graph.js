  ...
  const button = (label) => {
    ...
    return (
      <button
        ...
        className={
          "primary-gradient toggle-button margin-bottom-0-5 " +
      ...
      <main>
        <section className={"main-container"}>
          <article className={"main-content"} ref={filterRef}>
            ...
            <article
              className={"sunburst margin-top-1 align-center"}
              ref={diagramRef}
            />
          </article>
        </section>
