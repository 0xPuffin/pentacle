...
export const EthDecentralisedExchange = () => {
  ...
  const fetchProjects = async () => {
    setLoading(true);
    try {
      const response = await fetch("/projects/decentralised-exchange");
        ...
        <main className={"main-container"}>
          <section className={"main-content flex space-between padding-top-3"}>
            ...
            <article className={"fieldset inline boxed align-right"}>
              ...
              <input id="search" type="text" placeholder="Filter by project name" value={searchTerm} onChange={handleChange}/>
