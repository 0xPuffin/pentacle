    ...
    <section className={"main-container"}>
      <article className={"main-content"}>
        ...
        <article className={"margin-top-2 flex flex-start"}>
          {twitter_url && (
            <Button url={twitter_url} title="twitter" icon={twitter} />
          )}
          {discord_url && (
            <Button url={discord_url} title="discord" icon={discord} />
          )}
          {telegram_url && (
            <Button url={telegram_url} title="telegram" icon={telegram} />
          )}
          {medium_url && (
            <Button url={medium_url} title="medium" icon={medium} />
          )}
          {coingecko_url && (
            <Button url={coingecko_url} title="coingecko" icon={coingecko} />
          )}
          {github_url && (
            <Button url={github_url} title="github" icon={github} />
          )}
          {whitepaper_url && (
            <Button url={whitepaper_url} title="whitepaper" icon={whitepaper} />
          )}
          {docs_url && <Button url={docs_url} title="docs" icon={docs} />}
          {contract_url && (
            <Button url={contract_url} title="contract" icon={contract} />
          )}
        </article>
        <article className={"flex"}>
        ...
        <article className={"flex flex-start"}>
          {docs_url && (
            <Button url={llama_url} title="defi llama" icon={llama} />
          )}
